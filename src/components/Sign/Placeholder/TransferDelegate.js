      ...
      <div className="TransferInfo">
        <div className="TransferInfo__accounts">
          <div className="TransferInfo__account">
            <SteemitAvatar username={query.fromName} size="60" className="TransferInfo__avatar" type="large" />
          ...
          <div className="TransferInfo__account">
            <span className="TransferInfo__dots" />
            <SteemitAvatar username={query.toName} size="60" className="TransferInfo__avatar" type="large" />
